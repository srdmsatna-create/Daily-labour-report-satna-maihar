...
# Convert the existing SIPRI portal card into the Planner Portal dashboard card.
s = re.sub(
    r'<a class="srdm-app-card srdm-portal-card srdm-portal-sipri"[^>]*>.*?</a>',
    '<a class="srdm-app-card srdm-portal-card srdm-portal-sipri" href="planner-portal-dashboard.html" style="text-decoration:none">\n      '+planner_thumb+'<span class="srdm-app-copy"><strong>Planner Portal</strong><span>Janpad-wise • Panchayat-wise • New Work संख्या</span></span>\n    </a>',
...
if s != orig:
    ...
    print('Planner/JGSA/RIMS portal cards patched.')
else:
