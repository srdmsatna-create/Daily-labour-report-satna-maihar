...
git add -- index.html yuktdhara-data.js muster-emb-data.js scripts_local/update_yuktdhara_monitoring.py scripts_local/update_muster_emb_monitoring.py ONE_CLICK_DASHBOARD_DATA_UPDATE.bat
