...
title SRDM SATNA - Unified Application Modules V20
color 0A
...
echo Source     : %SOURCE%
echo Git root   : %REPO%
echo Moving report modules into SRDM Applications and removing duplicates...
...
git commit -m "Unify report modules in Applications grid and remove duplicates V20"
...
echo.
echo ============================================================
echo SUCCESS - Unified Application Modules V20 pushed.
...
:nosource
color 0C
echo ERROR: final\index.html is missing from extracted V20 package.
pause
exit /b 1
:nogit
color 0C
