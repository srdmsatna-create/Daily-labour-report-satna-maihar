...
let rows=BOOT_REPORT.rows||[],official=BOOT_REPORT.official||[],daily=BOOT_REPORT.daily||[],workmix=BOOT_REPORT.workmix||[],categorymix=BOOT_REPORT.categorymix||[],reportTitle=BOOT_REPORT.title||'',pendingFile=null,view='official',lastExport=[];
