...
function addOfficialFullTableSlide(ppt,data,scope){
  ...
  const h2=['Total GP','GP Progress','Dysfunctional','Labour','Works with MR','No e-KYC','Muster Rolls','Ongoing','MR %','Labour','Works MR','Labour','Works MR','Share %','Ongoing','MR Issued','MR %','Labour','Ongoing','MR Issued','MR %']
