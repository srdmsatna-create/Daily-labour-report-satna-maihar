...
title SRDM SATNA - Unique Colour Applications V18
color 0A
...
echo Source     : %SOURCE%
echo Git root   : %REPO%
echo Applying unique application colours, icons, borders and hover glow...
...
git commit -m "Apply unique colour identity to application cards V18"
...
echo.
echo ============================================================
echo SUCCESS - Unique Colour Applications V18 pushed.
...
:nosource
color 0C
echo ERROR: final\index.html is missing from extracted V18 package.
pause
exit /b 1
:nogit
color 0C
