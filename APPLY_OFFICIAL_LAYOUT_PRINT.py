...
body[data-report-view="official"] #reportTable{border-collapse:collapse!important;min-width:1660px!important;width:100%!important;table-layout:auto!important}
body[data-report-view="official"] #reportTable th{font-size:18px!important;font-weight:900!important;padding:10px 8px!important;line-height:1.16!important;white-space:normal!important;word-break:keep-all!important;overflow-wrap:normal!important;text-align:center!important}
body[data-report-view="official"] #reportTable td{font-size:17px!important;font-weight:750!important;padding:10px 8px!important;line-height:1.16!important;white-space:normal!important;word-break:keep-all!important;overflow-wrap:normal!important}
body[data-report-view="official"] #reportTable th,body[data-report-view="official"] #reportTable td{border:1.5px solid #6489a3!important;vertical-align:middle!important}
body[data-report-view="official"] #reportTable .print-select-col{width:64px!important;min-width:64px!important;max-width:64px!important;text-align:center!important;white-space:nowrap!important;word-break:normal!important}
body[data-report-view="official"] #reportTable th:nth-child(2),body[data-report-view="official"] #reportTable td:nth-child(2){min-width:98px!important;width:98px!important;white-space:nowrap!important;word-break:normal!important}
body[data-report-view="official"] #reportTable th:nth-child(3),body[data-report-view="official"] #reportTable td:nth-child(3){min-width:150px!important;width:150px!important;white-space:normal!important;word-break:keep-all!important;overflow-wrap:normal!important}
body[data-report-view="official"] #reportTable th:nth-child(4),body[data-report-view="official"] #reportTable td:nth-child(4){min-width:140px!important}
...
@media(max-width:900px){
 body[data-report-view="official"] #reportTable{min-width:1620px!important}
...
(function(){
  ...
  function addBar(t){
    ...
    document.getElementById('printOff').onclick=()=>{
      ...
      w.document.write('<html><head><title>Official Janpad Daily Report</title><style>@page{size:landscape;margin:8mm}body{font-family:Arial;padding:8px}table{border-collapse:collapse;width:100%}th,td{border:1px solid #56758d;padding:7px;font-size:14px;text-align:center;vertical-align:middle;word-break:keep-all;overflow-wrap:normal}th{background:#dfeaf4;font-weight:900;font-size:15px}</style></head><body><h2>Official Janpad Daily Report</h2>'+c.outerHTML+'<script>window.onload=()=>window.print()<\/script></body></html>');w.document.close();
    };
  }
  function run(){
    ...
    compactHeader(t);addChecks(t);addBar(t);updateCount();
  }
...
print('DONE: Official Janpad font enlarged further')
